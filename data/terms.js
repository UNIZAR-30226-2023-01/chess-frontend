export const TermsContent = {
  ...
  subsections: [
    ...
    },
    {
      ...
      description: 'Todos los derechos de propiedad intelectual en y para el sitio web son propiedad de REIGN y están protegidos por las leyes de derechos de autor y marcas registradas. No se le concede ninguna licencia o derecho a utilizar ninguna de estas marcas o logotipos sin nuestro permiso previo por escrito.',
    },
    {
      ...
      description: 'Este sitio web puede contener enlaces a otros sitios web de terceros que no son propiedad ni están controlados por REIGN. No tenemos control sobre el contenido, las políticas de privacidad o las prácticas de otros sitios web y no somos responsables de ellos.',
    }, {
      ...
      title: 'Ley aplicable',
      description: 'Estos términos de uso se regirán e interpretarán de acuerdo con las leyes del país o estado donde REIGN tiene su sede principal, sin referencia a los principios de conflicto de leyes.',
    },
  ],
};
